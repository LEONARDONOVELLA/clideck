  ...
  state.ws.onmessage = ({ data }) => {
    ...
    switch (msg.type) {
      case 'config':
        ...
        refreshAllStatusFrames(); // apply/clear status frames when the toggle changes
        break;
      case 'themes':
