...
const ALL_PANELS = ['chats', 'prompts', 'plugins', 'time', 'settings'];
const PANEL_TITLES = { chats: 'Sessions', prompts: 'Prompts', plugins: 'Plugins', time: 'Time Tracking', settings: 'Settings' };
